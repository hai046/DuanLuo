...
public class Weibo {
	...
	private void startDialogAuth(Activity activity, String[] permissions) {
		...
		mWeiboDialogListener = new WeiboDialogListener() {
			...
			public void onComplete(Bundle values) {
				...
				Log.d("Weibo-authorize",
						"Login Success! 11111111111111111111111   access_token="
		...
		dialog(activity, params, mWeiboDialogListener);
	}

	private WeiboDialogListener mWeiboDialogListener;

	public WeiboDialogListener getWeiboDialogListener() {
		return mWeiboDialogListener;
	}
